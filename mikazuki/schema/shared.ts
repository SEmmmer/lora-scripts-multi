(function () {
    ...
    let data = {
        ...
        DISTRIBUTED_TRAINING: Schema.object({
            ...
            nccl_socket_ifname: Schema.string().default("ensp11s0").description("NCCL 通信网卡名，如 eth0 / eno1 / wg0"),
            gloo_socket_ifname: Schema.string().default("ensp11s0").description("GLOO 通信网卡名，如 eth0 / eno1 / wg0"),
